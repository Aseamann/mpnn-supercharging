...
#SBATCH --constraint=ampere|adalovelace # GPU architecture
...
python protein_mpnn_supercharge.py -i pdb -o eGFPsc_smpnn_${charge}.fa -t 0.3 -c ${charge} -n 10 --model v_48_010 --weights soluble -mhbond -u -v
